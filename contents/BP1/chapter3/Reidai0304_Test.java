...
public class Reidai0304_Test {
    public static void doTest(int index, String a, String b) {
        ...
        String answer = "seisu1 = seisu2 = seisu1+seisu2 = " + (Integer.parseInt(a)+Integer.parseInt(b)) + "\n" ;
        String result = "";
        boolean success = false;

        try {
            Reidai0304_Main.main(new String[0]);
            result = out.toString();
            ...
            if (success) {
                ...
                System.out.println(String.format("ok %d 整数の入力と出力 正解!\n", index));
            } else {
