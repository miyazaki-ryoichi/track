...
public class Reidai0306_Test {
    public static void doTest(int index, String a) {
        ...
        String answer = "正方形の一辺の長さ>> 正方形の面積は " + (Integer.parseInt(a)*Integer.parseInt(a)) + " です\n" ;
        String result = "";
        boolean success = false;

        try {
            Reidai0306_Main.main(new String[0]);
            result = out.toString();
            ...
            if (success) {
                ...
                System.out.println(String.format("ok %d 図形の面積 正解!\n", index));
            } else {
